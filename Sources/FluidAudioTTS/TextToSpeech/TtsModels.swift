...
public struct TtsModels {
    ...
    public static func download(
        ...
        // Use CPU-only on simulator (GPU/Metal doesn't work properly)
        // Use CPU+NeuralEngine on real devices for better battery efficiency
        // ANE provides significant power savings for TTS workloads
