...
#ifndef FLUIDAUDIO_SWIFT_H
#define FLUIDAUDIO_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="FluidAudio",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10FluidAudio31ZeroCopyDiarizerFeatureProvider")
...
SWIFT_CLASS("_TtC10FluidAudio23ZeroCopyFeatureProvider")
@interface ZeroCopyFeatureProvider : NSObject <MLFeatureProvider>
@property (nonatomic, readonly, copy) NSSet<NSString *> * _Nonnull featureNames;
- (MLFeatureValue * _Nullable)featureValueForName:(NSString * _Nonnull)featureName SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
